//Haiden Gembinski
//Number controller script for Fill In Game Level 2

using System.Collections;
using System.Collections.Generic;
using UnityEngine;

public class NumberButtonsLevel2 : MonoBehaviour
{
    ...
    {
        char index;
        string newTestString = controller.GetComponent<FillInLevel2>().testString;
        ...
        for (int i = 0; i < newTestString.Length; i++) //iterate through string
        {
            ...
            if (index == '_') //if a blank is found, fill it in once with the number
            {
                ...
                controller.GetComponent<FillInLevel2>().testString = newTestString; //send the updated string to the other script
                break;
            }
        }
    }
    ...
    public void Button2()
    {
        ...
        for (int i = 0; i < newTestString.Length; i++)
        {
            ...
            if (index == '_')
            {
                ...
                controller.GetComponent<FillInLevel2>().testString = newTestString;
                break;
            }
        }
    }
    ...
    {
        controller.GetComponent<FillInLevel2>().testString = controller.GetComponent<FillInLevel2>().resetString;
