...
public class FillInLevel3 : MonoBehaviour
{
    public TMP_Text txt;
    string number;
    ...
    //scorekeeping
    int line = 12; //corresponds to line for level 3
    string score, file;
    string[] scores;
    int attempted, won;
   ...
   string GenerateBlanks(string number) //generates blanks in the number string
    {
        ...
        for (int i = 0; i < testString.Length; i++) //blank everything
        {
            testString = testString.Remove(i, 1).Insert(i, "_");
        }
