...
public class FillInLevel2 : MonoBehaviour
{
    public TMP_Text txt;
    string number;
    ...
    //scorekeeping
    int line = 10; //corresponds to line for level 2
    string score, file;
    string[] scores;
    int attempted, won;
   ...
   string GenerateBlanks(string number) //generates blanks in the number string
    {
        ...
        int blank1, blank2, blank3, blank4, blank5, blank6;
        Random rnd = new Random();

        blank1 = rnd.Next(0, 10);
        blank2 = rnd.Next(0, 10);
        blank3 = rnd.Next(0, 10);
        blank4 = rnd.Next(0, 10);
        blank5 = rnd.Next(0, 10);
        blank6 = rnd.Next(0, 10);

        //ensure no blank is the same
        while (blank2 == blank1 || blank2 == blank3 || blank2 == blank4 || blank2 == blank5 || blank2 == blank6)
        {
            blank2 = rnd.Next(0, 10);
        }

        while (blank3 == blank1 || blank3 == blank2 || blank3 == blank4 || blank3 == blank5 || blank3 == blank6)
        {
            blank3 = rnd.Next(0, 10);
        }

        while (blank4 == blank1 || blank4 == blank2 || blank4 == blank3 || blank4 == blank5 || blank4 == blank6)
        {
            blank4 = rnd.Next(0, 10);
        }

        while (blank5 == blank1 || blank5 == blank2 || blank5 == blank3 || blank5 == blank4 || blank5 == blank6)
        {
            blank5 = rnd.Next(0, 10);
        }

        while (blank6 == blank1 || blank6 == blank2 || blank5 == blank3 || blank6 == blank4 || blank6 == blank5)
        {
            blank6 = rnd.Next(0, 10);
        }
        ...
        testString = testString.Remove(blank4, 1).Insert(blank4, "_");
        testString = testString.Remove(blank5, 1).Insert(blank5, "_");
        testString = testString.Remove(blank6, 1).Insert(blank6, "_");
